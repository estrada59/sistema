...
class MYPDF extends TCPDF {
	...
	public function tratamiento(){
		...
		$this->TextBox('LISTA DE DOCTORES QUE ENVIAN PACIENTES DE FORMA PARTICULAR', 0,45, 180, 5, 1, 'C');
		...
		$this->TextBox('Estudio realizado', 75,$y,  60, 5, 1, 'C');
		...
		//while($cont > 0){
			if ($max_fila > 0 ){
				...
				$this->TextBox($row->estudio, 75,$y,  60, 5, 1, 'C');
				...
				$this->SetFont('Helvetica', 'B', 11, '', 'false');
				$this->TextBox('LISTA DE DOCTORES QUE ENVIAN PACIENTES DE FORMA PARTICULAR', 0,$y, 180, 5, 1, 'C');
