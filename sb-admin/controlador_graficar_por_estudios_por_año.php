       ...
       ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Graficar por etudios realizados anualmente<small>
                            </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                 Graficar por etudios realizados anualmente
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_graficar_estudios_anualmente.php">
