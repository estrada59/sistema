       ...
       ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Comisión de pacientes (SPECT cardiacos)<small>
                            </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                 Corte realizado por mes
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_ver_lista_medicos_spect_cardiacos.php" >
