            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <?php 
                                ...
                                $mañana        = date("Y-m-d", strtotime("next day"));
                                $fecha_l = fecha_letras($mañana);
                ...
                <?php 
                    ...
                    if($_SESSION['nivel_acceso'] <= 3 ){
                        ver_pacientes_mañana($mañana,$_POST["pagina"]); //muestra con franjas de color
                    }
                    if($_SESSION['nivel_acceso'] == 4 ){ //muestra sin franjas de color
                        ver_pacientes_mañana($mañana,$_POST["pagina"]);
                    }
