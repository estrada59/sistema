...
function menu($pag){
    ...
    echo'
        ...
        echo '
            <li class ="'.$facturas.' ">
                <a href="javascript:;" data-toggle="collapse" data-target="#demo3"><span class="glyphicon glyphicon-list-alt" ></span> Facturas <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="demo3" class="collapse">
                    <li>
                        <a href="controlador_ver_pacientes_por_mes_factura.php">Ver por mes</a>
                    </li>
                </ul>
            </li>
            <li class ="'.$grafica.' ">
