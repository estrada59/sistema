                                ...
                                <?php
                                    ...
                                    echo '<thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center">Estatus de Compra</th>
                                    ...
                                    while($row =  $mysql->f_obj($sql)){
                                        ...
                                        if($row->id_estatus_detalle == 3){
                                            echo '<tr class="success">';
                                                ...
                                                echo '<td>'.$row5->estatus_solicitud.'</td>';
                                                            ...
                                                            <div class="modal-dialog modal-sm" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form id="form_editar'.$row->id_detalle_pedidos.'" action="pedidos_data_update_estatus_recibido.php"  method="post">
                                                                            <input type="hidden" name="id_pedidos" value="'.$id_pedido.'" form="form_editar'.$row->id_detalle_pedidos.'">
                                                                            <input type="hidden" name="up_status_general" value="'.$up_status_general.'" form="form_editar'.$row->id_detalle_pedidos.'">
                                                                            <input type="hidden" name="id_detalle_pedido" value="'.$row->id_detalle_pedidos.'" form="form_editar'.$row->id_detalle_pedidos.'">
                                                                            <select class="form-control " form="form_editar'.$row->id_detalle_pedidos.'" name="estatus_producto" >
                                                                                <option value="0">   </option>';


                                                                                $cad3 = " SELECT t1.id_status_pedido, t1.descripcion
                                                                                            from tblc_status_pedido t1
                                                                                            where t1.activo=1;";

                                                                                $sql3 = $mysql->query( $link, $cad3);
                                                                                
                                                                                while($row3 =  $mysql->f_obj($sql3)){
                                                                                    echo '<option value="'.$row3->id_status_pedido.'"> '.$row3->descripcion.'</option>';
                                                                                }
                                                ...
                                                echo'
                                                                            ...
                                                                            <textarea class="form-control " form="form_editar'.$row->id_detalle_pedidos.'"    name="cancelacion" maxlength="190"></textarea>
                                                                        </form>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="submit" form="form_editar'.$row->id_detalle_pedidos.'" class="btn btn-warning btn-sm" >
                                                                            Guardar cambios
                                                                        </button>
                                                                    </div>
                                                                </div>
