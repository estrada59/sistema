    ...
    <div id="wrapper">
       ...
       ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-3">
                            <form role="form" id="ver_lista" method="post" action="controlador_eliminar_lista_de_precios.php">
                            </form>
            ...
            <form  role="form" id="editar_lista" method="post" action="view_eliminar_lista_de_precio.php">
                <?php
                     echo'
