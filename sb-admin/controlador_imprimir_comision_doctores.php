<!DOCTYPE html>
<?php $_POST["pagina"]="imprimir_comision"; ?>
<html lang="en">
       ...
       <?php include_once "include/nav_session.php" ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Lista de doctores que envian pacientes.<small>
                            </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                 Lista de doctores que envían pacientes
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <!-- <form role="form" id="ver_pacientes" method="post" action="view_imprimir_comision_doctores.php" target="_blank">-->
               <form role="form" id="ver_pacientes" method="post" action="viewmod_ver_lista_medicos.php" >
