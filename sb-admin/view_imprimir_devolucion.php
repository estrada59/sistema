...
class MYPDF extends TCPDF {
	...
	public function Recibo_paciente($ax_x, $ax_y) {
		...
		//$this->CreateTextBox('www.numedics.com.mx', 117+$ax_x,45+$ax_y, 80, 10, 10, '');
				...
				*/	
                    $this->SetFont('Helvetica', '', 14, '', 'false');
                    $this->CreateTextBox('Recibo ', 0, 50, 80, 10, 10, 'B');

                    $fecha = date('d-m-Y');
                    $this->SetFont('Helvetica', '', 12, '', 'false');
					$this->CreateTextBox('Tuxtla Gutiérrez, Chiapas a   '.$fecha, 80, 50, 80, 10, 10, 'B');
					$this->CreateTextBox('Recibí de MEDICINA NUCLEAR DE CHIAPAS S. DE R. L. DE C. V.', 0, 60, 80, 10, 10, '');

					$this->CreateTextBox('la cantidad de: ', 0, 70, 80, 10, 10, '');
					$this->CreateTextBox('$ 1,500.00', 30, 70, 80, 10, 10, 'B');
					$this->CreateTextBox('(Ciento treinta y un pesos 00/100 M. N.)', 0, 75, 80, 10, 10, 'B');
					$this->CreateTextBox('Por concepto de DEVOLUCION ', 0, 80, 80, 10, 10, '');
