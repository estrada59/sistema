       ...
       ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar TIPO DE ESTUDIO del paciente.<small>
                            </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                Puedes cambiar el tipo de estudio del paciente siempre y cuando no hayas cobrado nada. En el caso de
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_ver_editar_estudio_de_paciente.php">
