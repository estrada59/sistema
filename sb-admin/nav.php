...
function menu($pag){
    ...
    echo'
            ...
            <li class ="'.$facturas.' ">
                <a href="javascript:;" data-toggle="collapse" data-target="#demo4"><span class="glyphicon glyphicon-list-alt" ></span> Facturas <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="demo4" class="collapse">
                    <li>
                        <a href="controlador_ver_pacientes_por_mes_factura.php">Facturas</a>
                    </li>
                    <li>
                        <a href="controlador_ver_folios_facturas.php">Imprimir folios</a>
                    </li>
                </ul>
            </li>';
