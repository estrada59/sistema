<!DOCTYPE html>
<?php $_POST["pagina"]="editar_pacientes_por_fecha"; ?>
<html lang="en">
       ...
       ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar paciente de institución a particular<small>
                            </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                Aquí se modifica la institución del paciente y se cambia a particular
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_ver_editar_institucion_a_particular.php">
