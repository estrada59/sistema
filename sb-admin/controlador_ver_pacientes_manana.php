<!DOCTYPE html>
<?php $_POST["pagina"]="ver_pacientes_mañana"; ?>
<html lang="en">
       ...
       ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_ver_pacientes_del_dia.php">
                  <!--  <div class="form-group">
                    ...
                    <?php
                        $fecha_act = date('Y-m-d', strtotime('+1 day'));
                        echo '<input type="hidden" name="fecha_estudios" id="fecha_estudios" form="ver_pacientes" value="'.$fecha_act.'">';
                    ?>
                </form>
