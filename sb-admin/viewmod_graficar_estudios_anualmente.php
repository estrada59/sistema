                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                ...
                                Lista de estudios por año <?php echo '<small> del '.$fecha_ini.' al '.$fecha_fin.'</small>'; ?>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">Lista de estudios realizados y ATENDIDOS <?php echo ' del '.$fecha_ini.' al '.$fecha_fin; ?></h3>
