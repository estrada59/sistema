...
echo '          <p><strong>Estos datos se Habilitarán ¿Está seguro?</strong> </p>';
    ...
    <div id="wrapper">
       ...
       ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Confirmar Habilitación de institucion.
                            </li>
                        </ol>
                        <div class="col-lg-3">
            ...
            <form  role="form" id="editar_lista" method="post" action="view_habilitar_lista_precios.php">
                <?php
                     echo'
