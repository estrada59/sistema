       ...
       ?>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Relación de pacientes por mes de la institucion: 
                            <?php
                            $institucion = pasarMayusculas($_POST['institucion']);;
                             echo ''.$institucion.'';?><small>
                            </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_relacion_instituciones_por_mes.php">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="institucion" value=<?php echo '"'.$_POST['institucion'].'"' ?>>
                    </div>
                </form>
