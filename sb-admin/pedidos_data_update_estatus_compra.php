                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            Se actualizó el estatus de compra
                        </h3>                       
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <?php
                            ...
                            if(isset($_POST)){
                                ...
                                $cad="UPDATE tbl_solicitud_pedidos
                                SET id_empresas = $id_empresa, id_status_solicitudes = $estatus_solicitud, fecha_solicitud = '$fecha'
