        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                ...
                                <?php 
                                    ...
                                    $fecha_l = fecha_letras($semana['lunes']);
                                    $fecha_s = fecha_letras($semana['domingo']);
                                    echo 'Pacientes citados del '.$fecha_l.' al '.$fecha_s;
                                ?>
                            </li>
                        </ol>
                    </div>
                ...
                <form role="form" id="ver_pacientes" method="post" action="viewmod_ver_pacientes_por_semana.php">
                    <?php echo'<input type="hidden" name="fecha_estudios" value="'.$f.'"> ';   ?>
                </form>
